...
export default function KYCVerification({
  ...
  const [aadhaarLoading, setAadhaarLoading] =
    useState(false)

  const [aadhaarMsg, setAadhaarMsg] =
    useState('')

  const [aadhaarErr, setAadhaarErr] =
    useState('')
      ...
      <div className="flex items-start gap-3 p-4 rounded-xl bg-sky-50 border border-sky-100">
        ...
        <div>
          ...
          <p className="text-xs text-sky-600 mt-0.5">
            ...
            After Aadhaar OTP, our AI agents will
            automatically process your application.
          </p>
        </div>
      </div>
