  ...
  return (
    <div className="mb-8">
          ...
          return (
            <div key={i} className="flex items-center flex-1 last:flex-none">
              <div className="flex flex-col items-center">
                ...
                <span className={`text-[11px] mt-2 text-center leading-tight max-w-[90px] font-medium
              ...
              {i < steps.length - 1 && (
                <div className="flex-1 relative h-[2px] mx-2 mb-4 bg-slate-200 rounded">
                  {done && <div className="absolute inset-0 bg-green-400 rounded" />}
                </div>
              )}
            </div>
          )
      ...
      <div className="prog-track mt-4">
        <div className="prog-fill" style={{ width: `${(current / (steps.length - 1)) * 100}%` }} />
      </div>
    </div>
  )
}
